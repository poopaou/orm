...
public final class TypeDefinition {
    ...
    TypeDefinition(@Nonnull String tableName, @Nonnull String typeSimpleName, @Nonnull String typeQualifiedName,
                   @Nonnull String packageName, @Nullable String beforeInsertMethod, @Nullable String beforeUpdateMethod,
                   ...
                   @Nonnull PropertyDefinition[] columns, @Nonnull ConstraintDefinition[] constraintDefinitions,
