...
import org.medimob.orm.processor.ProcessorUtils;
...
public final class Orm {
    ...
    private Orm(Context context) throws PackageManager.NameNotFoundException, IOException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        ApplicationInfo meta = pm.getApplicationInfo(context.getPackageName(), PackageManager.GET_META_DATA);
