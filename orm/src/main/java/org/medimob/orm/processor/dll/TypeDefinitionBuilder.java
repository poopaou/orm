...
public class TypeDefinitionBuilder {
    ...
    public TypeDefinitionBuilder addConstraint(ConstraintDefinition constraintDefinition) throws MappingException {
        addOrThrowIfExist(constraintDefinitions, constraintDefinition, "Constraint "+ constraintDefinition +" already exist in table");
        return this;
    }
    ...
    public TypeDefinition build() throws MappingException {
        validate();
        return new TypeDefinition(tableName, typeSimpleName, typeQualifiedName, packageName, beforeInsertMethod,
                beforeUpdateMethod, beforeDeleteMethod, idColumn, versionColumn, createStatement(),
                columns.toArray(new PropertyDefinition[columns.size()]),
                constraintDefinitions.toArray(new ConstraintDefinition[constraintDefinitions.size()]),
