...
public final class SqlUtils {
    ...
    public static String createSqlInsert(String insertInto, String tableName, String[] columns, String version) {
    ...
    public static String createSqlUpdate(String tablename, String[] updateColumns, String id, String version) {
